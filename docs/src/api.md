...
- **NGSI-LD HTTP API** — ETSI's own OpenAPI document (`docs/openapi/ngsi-ld-api.yaml`, vendored at a pinned tag), rendered with ReDoc:
  <https://antaresbroker.joinedcontext.com/openapi/ngsi-ld.html>
